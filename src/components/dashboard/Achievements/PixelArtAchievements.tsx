/**
 * Компонент достижений пиксель-арт игры
 * Отображает список достижений с прогрессом
 * Соблюдает принцип Single Responsibility
 */

import React from "react";
import type { PixelArtAchievement } from "@/types/pixel-art-achievements.types";
import styles from "./Achievements.module.css";

export interface PixelArtAchievementsProps {
 ...
 * Компонент достижений пиксель-арт игры
 */
export const PixelArtAchievements: React.FC<PixelArtAchievementsProps> = ({
  achievements,
  className = "",
}) => {
